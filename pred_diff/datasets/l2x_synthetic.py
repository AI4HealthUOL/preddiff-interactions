"""
adapted from https://github.com/Jianbo-Lab/L2X/blob/master/synthetic/make_data.py
...
def generate_data(n=100, datatype='', seed = 0):
    ...
    return generate_labels(X)
     

#################
#NEW

def generate_l2x_synthetic(n=100, dataset="orange_skin"):
    x,y,d = l2x_synthetic.generate_data(datatype=dataset)
